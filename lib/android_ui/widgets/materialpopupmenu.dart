...
/// shows a popup menu, consider using [MaterialPopupMenuButton].
///
...
/// {@end-tool}
///
/// See the example at [MaterialPopupMenuButton] for how this example could be used in a
...
///  * [MaterialPopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.

class MaterialPopupMenu<T> extends StatelessWidget {
  const MaterialPopupMenu(
      {super.key,
      required this.route,
        ...
        return
          ...
          child: Material(
            ...
            child: Align(
              ...
              widthFactor: route.animation!.status == AnimationStatus.forward ||
                      route.animation!.status == AnimationStatus.completed
                  ? width.evaluate(route.animation!)
                  : 1,
              heightFactor:
                  route.animation!.status == AnimationStatus.forward ||
                          route.animation!.status == AnimationStatus.completed
                      ? height.evaluate(route.animation!)
                      : 1,
              child: child,
            ),
          ),
...
class MaterialPopupMenuRoute<T> extends PopupRoute<T> {
  MaterialPopupMenuRoute(
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
    ...
    final Widget menu = MaterialPopupMenu<T>(
      route: this,
...
///  * [MaterialPopupMenuButton], which provides an [IconButton] that shows a menu by
...
Future<T?> showMenu<T>(
  ...
  return navigator.push(MaterialPopupMenuRoute<T>(
      position: position,
      items: items,
...
/// dismissed.
///
/// Used by [MaterialPopupMenuButton.onSelected].
typedef PopupMenuItemSelected<T> = void Function(T value);

/// Signature for the callback invoked when a [MaterialPopupMenuButton] is dismissed
/// without selecting an item.
///
/// Used by [MaterialPopupMenuButton.onCanceled].
typedef PopupMenuCanceled = void Function();

/// Signature used by [MaterialPopupMenuButton] to lazily construct the items shown when
/// the button is pressed.
///
/// Used by [MaterialPopupMenuButton.itemBuilder].
...
/// then [MaterialPopupMenuButton] behaves like an [IconButton].
///
...
///  * [CheckedPopupMenuItem], a popup menu item with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
class MaterialPopupMenuButton<T> extends StatefulWidget {
  /// Creates a button that shows a popup menu.
  ///
  /// The [itemBuilder] argument must not be null.
  const MaterialPopupMenuButton({
    super.key,
  ...
  // the curve to use to animate the menu and its items
  final Curve curve;
  ...
  @override
  MaterialPopupMenuButtonState<T> createState() =>
      MaterialPopupMenuButtonState<T>();
}

/// The [State] for a [MaterialPopupMenuButton].
///
/// See [showButtonMenu] for a way to programmatically open the popup menu
/// of your button state.
class MaterialPopupMenuButtonState<T>
    extends State<MaterialPopupMenuButton<T>> {
  /// A method to show a popup menu with the items supplied to
  /// [MaterialPopupMenuButton.itemBuilder] at the position of your [MaterialPopupMenuButton].
  ///
  /// By default, it is called when the user taps the button and [MaterialPopupMenuButton.enabled]
  /// is set to `true`. Moreover, you can open the button by calling the method manually.
  ///
  /// You would access your [MaterialPopupMenuButtonState] using a [GlobalKey] and
